    ...
    <>
      <div className="h-[calc(100vh-60px)] flex items-center justify-between px-12 bg-linear-to-r from-[#0B1120] to-[#1e3b8a] text-white">
        ...
        <div id="home" className="home-section">
          ...
          <h1
            ...
            data-aos-delay="100"
          >
            Diya <span className="text-blue-600">Bora</span>
          </h1>
          <h3
            className="text-4xl mt-2.5"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            {" "}
            M<span className="text-orange-200">E</span>
            <span className="text-green-300">R</span>N Stack Developer
          </h3>
          <p className="text-lg mt-4" data-aos="fade-up" data-aos-delay="300">
            I build modern, responsive, and scalable web
            <br /> applications using MongoDB, Express.js,
            <br /> React, and Node.js.
          </p>
          <div className="btn flex gap-6 items-center mt-4">
            <button
              className="bg-blue-600 hover:bg-blue-700 font-semibold py-2 px-6 rounded-md cursor-pointer"
              data-aos="fade-right"
            >
              Hire me
            </button>
            <Link to="https://wa.me/7455921052" target="_blank ">
              <button
                className="py-2 flex px-6 border rounded-md hover:bg-blue-600 hover:border-blue-500 cursor-pointer"
                data-aos="fade-left"
                data-aos-delay="400"
              >
                Contact Me{" "}
          ...
          <p className="text-lg mt-4" data-aos="fade-up" data-aos-delay="500">
            Connect with me
          </p>
          <div className="social-icons flex gap-6 mt-2 text-xl">
            <span
              className="border border-white/10 bg-white/5 p-2 rounded-lg cursor-pointer "
              data-aos="fade-up"
              data-aos-delay="600"
            >
              {" "}
              <Link to="https://github.com/diyabora" target="_blank ">
                <FaGithub />
              </Link>
            </span>
            <span
            ...
            >
              {" "}
              <Link to="https://www.linkedin.com/in/diya-bora" target="_blank ">
                <FaLinkedinIn />
              </Link>
            </span>
            <span
            ...
            >
              <Link
                to="https://www.instagram.com/mehandiart_diya"
                target="_blank "
              >
                <CiInstagram />
              </Link>
        ...
        <div className="img-section">
          <img
            src="path/to/diya-bora-image.jpg"
            alt="Diya Bora"
        ...
        <div className="to-do-section px-10 gap-4 flex flex-col">
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            <div
              ...
              data-aos-delay="100"
            >
              <div className="text-blue-500 flex justify-center text-[40px]">
                <RiComputerLine />
              </div>
              <p className="">Web Development</p>
            </div>
            <div
              className="web-card  rounded-xl shadow-lg border border-white/10 bg-[#111827]/30  py-3 text-center flex flex-col gap-2 "
              data-aos="fade-left"
              data-aos-delay="100"
            >
              <div className="text-blue-500 flex justify-center text-[40px]">
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            <div
              className="web-card  rounded-xl shadow-lg border border-white/10 bg-[#111827]/30  text-center flex flex-col gap-2 py-3  "
              data-aos="fade-right"
              data-aos-delay="300"
            >
              <div className="text-blue-500 flex justify-center text-[40px]">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mt-10">
          <div
            className="bg-white/10  border-black rounded-xl  flex flex-col gap-2 shadow-2xl px-6 py-4"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            ...
            <p className="text-[17px] text-white/90">
              A travel booking platform with real-time availability and
              pricing{" "}
            </p>
            <div className="project-technologies flex gap-2.5 text-white/90 mt-3">
              <div className=" border border-blue-900 rounded-xl px-3 py-1 ">
                React
              </div>
              <div className="border border-blue-900 rounded-xl px-3 py-1 ">
                Node.js
          ...
          >
            ...
            <p className="text-[17px] text-white/90">
              A responsive website built with Bootstrap and React{" "}
            </p>
            <div className="project-technologies flex gap-2.5 text-white/90 mt-3">
              <div className=" border border-blue-900 rounded-xl px-3 py-1 ">
                React
          ...
          >
            ...
            <p className="text-[17px] text-white/90 leading-4.5">
              A complete library management system with authentication, CRUD
      ...
      <div className=" bg-[#1a243b] grid lg:grid-cols-2 text-white px-12 ">
        <div className="experience-section border-e border-r-white/10 px-5 ">
          ...
          <p className="">
            ...
            <br /> projects,improving my skills,
            <br /> and learning new technologies.
          </p>
        </div>
        <div className="education-section px-5 py-10">
          <div className="section-title ">
            <h2 className="relative text-3xl font-semibold">
              Education
              <span className="absolute w-8 h-[3px] bg-cyan-400 left-[0px] bottom-[-10px] "></span>
            </h2>
          </div>
          <div className="education-container space-y-10 border-l-2 border-slate-700  mt-6">
            <div className="relative pl-5">
              <div className="absolute h-4 w-4 rounded-full bg-cyan-400 left-[-9px] top-[5px] shadow-[0_0_10px_#22d3ee]"></div>
              <div className="grid grid-cols-1 md:grid-cols-[150px_1fr] ">
                <span className="text-slate-400 ">2023-2025 </span>
                <div>
                  <h3 className="text-lg  font-semibold">
                    Bachelor of Computer Applications (BCA)
                  </h3>
                  <p className="text-slate-400 text-sm">
                    Surajmal University, Kiccha, U.S.Nagar
                  </p>
                </div>
              </div>
            </div>
            <div className="relative pl-5">
              <div className="absolute h-4 w-4 rounded-full bg-slate-400 left-[-9px] top-[5px] "></div>
              <div className="grid grid-cols-1 md:grid-cols-[150px_1fr] ">
                <span className="text-slate-400 ">2022 </span>
                <div>
                  <h3 className="text-lg  font-semibold">Higher Secondary</h3>
                  <p className="text-slate-400 text-sm">
                    S.H.M.J. Saraswati Vihar Senior Secondary School, Shantipuri
                    no.2
                  </p>
                </div>
              </div>
            ...
            <div className="relative pl-5">
              <div className="absolute h-4 w-4 rounded-full bg-slate-400 left-[-9px] top-[5px] "></div>
              <div className="grid grid-cols-1 md:grid-cols-[150px_1fr] ">
                <span className="text-slate-400 ">2020 </span>
                <div>
      ...
      <div className="getIntouch h-fit-content grid lg:grid-cols-3  text-white bg-[#0B1120] px-16 py-14 ">
        <div className="details  flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <p>divyanshibora005@gmail.com</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-blue-600 text-lg">
              <IoCall />
        ...
        <div id="contact" className="detail-form col-span-2">
          <form action="" className="w-full p-3">
            <div className="flex gap-4 mb-3">
              <input
                type="text"
                className="bg-white/10 px-4 py-2 focus:ring-1 focus:ring-blue-500 w-full rounded-lg outline-none"
            ...
            <div className="mb-3">
              <input
                type="text"
                className="bg-white/10 w-full px-4 py-2 focus:ring-1 focus:ring-blue-500 outline-none  rounded-lg "
                placeholder="Subject"
              />
            </div>
            <div className="mb-3">
              <textarea
                ...
                rows={3}
                className="bg-white/10 w-full px-4 py-2 rounded-lg focus:ring-1 focus:ring-blue-500 outline-none"
              ></textarea>
            </div>
            <div>
              <button className="bg-blue-600 px-4 py-2 rounded-lg w-50 cursor-pointer hover:bg-blue-700">
                Send Message
              </button>
            </div>
          </form>
        ...
        <div className="">
          ...
          <div className="social-icons flex gap-6 mt-4 text-xl">
            ...
            <span
              ...
              data-aos-delay="150"
            >
              <Link to="https://www.instagram.com/*/98" target="_blank ">
                <CiInstagram />
              </Link>
            </span>
          </div>
